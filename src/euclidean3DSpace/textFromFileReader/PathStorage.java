    ...
    public static Path LoadPath(String directory, String fileName) {
        ...
        try {
            ...
            while (reader.hasNextLine()) {
                ...
                String[] splittedText = currentLine.trim()  //TO DO: add "\\s+" to RemoveEmptyEntries
                        .split("X = |,| |Y = |Z = |X:|X: |Y:|Y: |Z:|Z: ");  //Use Regular expression OR "|" , to catch many strings. Example --> "ABC|abc|ONE|two"
